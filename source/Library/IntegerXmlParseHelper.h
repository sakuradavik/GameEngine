...
namespace Library
{
	...
	class IntegerXmlParseHelper : public IXmlParseHelper
	{
	...
	public:
		...
		* Constructor
		*/
		IntegerXmlParseHelper();

		/**
		* Virtual Destructor
		*/
		~IntegerXmlParseHelper() = default;

		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		IntegerXmlParseHelper(const IntegerXmlParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		IntegerXmlParseHelper& operator=(const IntegerXmlParseHelper& rhs) = delete;
