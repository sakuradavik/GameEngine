...
namespace Library
{
	class EntityParseHelper : public IXmlParseHelper
	{
	public:
		EntityParseHelper();
		~EntityParseHelper() = default;
		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		EntityParseHelper(const EntityParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		EntityParseHelper& operator=(const EntityParseHelper& rhs) = delete;
