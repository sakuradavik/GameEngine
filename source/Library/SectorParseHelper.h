...
namespace Library
{
	class SectorParseHelper : public IXmlParseHelper
	{
	public:
		SectorParseHelper();
		~SectorParseHelper() = default;
		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		SectorParseHelper(const SectorParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		SectorParseHelper& operator=(const SectorParseHelper& rhs) = delete;
