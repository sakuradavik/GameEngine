...
namespace Library
{
	...
	public:
		ActionParseHelper();
		~ActionParseHelper() = default;
		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		ActionParseHelper(const ActionParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		ActionParseHelper& operator=(const ActionParseHelper& rhs) = delete;
		...
		*/
		...
		static const std::string CreateString;
		static const std::string NameString;
		static const std::string InstanceString;
		static const std::string ClassString;
		static const std::string DestroyString;
