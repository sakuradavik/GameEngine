...
namespace Library
{
	...
	public:
		...
		* Constructor
		*/
		MatrixXmlParseHelper();

		/**
		* Virtual Destructor
		*/
		~MatrixXmlParseHelper() = default;

		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		MatrixXmlParseHelper(const MatrixXmlParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		MatrixXmlParseHelper& operator=(const MatrixXmlParseHelper& rhs) = delete;
