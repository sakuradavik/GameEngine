...
namespace Library
{
	...
	public:
		...
		* Constructor
		*/
		StringXmlParseHelper();

		/**
		* Virtual Destructor
		*/
		~StringXmlParseHelper() = default;

		/**
		* Copy Constructor. This method is not allowed to be used
		*/
		StringXmlParseHelper(const StringXmlParseHelper& rhs) = delete;

		/**
		* Assignment Operator. This method is not allowed to be used
		*/
		StringXmlParseHelper& operator=(const StringXmlParseHelper& rhs) = delete;
